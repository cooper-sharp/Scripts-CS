...
Proposer_Options = [A;B;A]; % Now the options are counterbalanced
...
%         end
        ...
        name = ['Subject_' sprintf('%04d',jj+10000) '_run_' num2str(aa) '.csv'];
